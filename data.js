...
const GROUPS = {
  WORLD: {
    name: 'Весь мир', nameEn: 'World',
    description: 'Все страны с доступными данными',
    descriptionEn: 'All countries with available data',
    members: 'all',
  },
  EU: {
    name: 'Европейский союз', nameEn: 'European Union',
    description: '27 стран ЕС',
    descriptionEn: '27 EU member states',
